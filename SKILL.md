...
description: Generates a repo-specific orientation.md resource for the agent-learning-opportunities skill. Only invoke via slash command (/create-orientation). Do not trigger automatically.
...
> Generated by /create-orientation. Re-run to update.
...
- That they can re-run `/create-orientation` at any time to regenerate it as the codebase evolves
